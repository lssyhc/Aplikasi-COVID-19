package com.example.retrofit_cahyo_06.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.example.retrofit_cahyo_06.databinding.ItemProvinceBinding
...
class ProvinceAdapter(private var list: ArrayList<ProvinceResponse>) :
    ...
    inner class ProvinceViewHolder(val binding: ItemProvinceBinding) :
